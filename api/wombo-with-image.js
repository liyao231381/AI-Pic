...
export default async function handler(req, res) {
    ...
    const { prompt, aspect_ratio, style, display_freq, mediastore_id, weight } = req.body;
  
    if (!prompt || !aspect_ratio || !style || !display_freq || !mediastore_id || !weight) {
